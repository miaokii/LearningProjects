...
struct KeychainItem {
    ...
    init(service: String = Bundle.main.infoDictionary?["CFBundleIdentifier"] as? String ?? "",
         account: String,
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(account: "user").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(account: "user").deleteItem()
        } catch {
