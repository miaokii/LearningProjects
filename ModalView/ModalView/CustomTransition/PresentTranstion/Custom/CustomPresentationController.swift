...
class CustomPresentationController: UIPresentationController {
    ...
    override func presentationTransitionWillBegin() {
        ...
        */
        ...
        presentationRoundedView.frame = presentationShadowView.bounds.inset(by: .init(top: 0, left: 0, bottom: -corner_radius, right: 0))
        presentationRoundedView.layer.cornerRadius = corner_radius
        ...
        */
        ...
        presentViewControllerWrapperView.frame = presentationRoundedView.bounds.inset(by: .init(top: 0, left: 0, bottom: corner_radius, right: 0))
        ...
        dimmingView.addGestureRecognizer(UITapGestureRecognizer.init(target: self, action: #selector(dimmingViewTapped(sender:))))
